...
This is a fork of the official Tuya Homebridge Plugin to add support for the Morphy Richards Ductless Air Conditioner and additional Leak Sensors.

### Morphy Richards Air Cool Max / Ductless Air Conditioner

This product exposes 6 items to the Apple Home app grouped as one:

1. A fan to turn on the fan and adjust speed. This fan also has a setting for childlock and to turn on/off oscillation which targets both horizontal and vertical in one.
